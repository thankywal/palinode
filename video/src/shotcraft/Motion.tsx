...
//
// Unmodified except for this header. The easing table, the segment primitive
// and the design-coordinate stage are the vocabulary every shot card in that
// library is written in, so the shots adopted here are written in it too.
